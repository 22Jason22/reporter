...
$beneficiario = isset($_POST['nombre']) ? $_POST['nombre'] : null;
...
if (!empty($beneficiario)) $fields[] = "nombre = '$beneficiario'";
...
if (!empty($municipio)) $fields[] = "municipio = '$municipio'";
...
if (count($fields) > 0) {
    $sql = "UPDATE trabajadas SET " . implode(", ", $fields) . " WHERE id = '$user_id'";
