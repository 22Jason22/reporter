...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO solicitudes (tipo_sujeto, identificador, nombre, telefono, sexo, edad, hectareas, id_solicitud, id_expediente, id_punto_cuenta, estatus_punto_cuenta, cedula, estado, municipio, parroquia, sede, nro_expediente) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        header("Location: ../solicitudes.php?mensaje=Datos añadidos correctamente");
