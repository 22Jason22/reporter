        ...
        <tbody>
            ...
            foreach ($reportes as $reporte) { ?>
                <tr id="empleado_<?php echo $reporte['id']; ?>">
                    ...
                    <td>
                        <a title="Ver detalles del empleado" href="#" onclick="verDetallesReporte(<?php echo $reporte['id']; ?>)" class="btn btn-success">
                            <i class="bi bi-binoculars"></i>
                        </a>
                        <a title="Eliminar datos del empleado" href="#" onclick="EliminarReporte(<?php echo $reporte['id']; ?>)" class="btn btn-danger">
